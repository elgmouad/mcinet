...
import { createControleLoi3108 } from '../../../Redux/Actions/control.actions';
import Print from './pv'

export const NewControleLoi3108 = () => {
    ...
    const next = async (e) => {
        ...
        if (step < steps.length) {
            ...
            try {
                const isSuccess = dispatch(createControleLoi3108(control));//await dispatch(createControl(control, "CONTROLE_LOI_79_IMPORTATION"));

                if (isSuccess) {
                    theNavigate('/dashboard/orderMissions/control/list', { state: { message: "Contrôle créé avec succès !" } });
                } else {
            ...
            // dispatch(createControleLoi3108(control));
...
export default NewControleLoi3108;